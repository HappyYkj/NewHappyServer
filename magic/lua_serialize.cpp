...
static constexpr int32_t WORKER_ID_SHIFT = 24;
static constexpr int64_t UPDATE_INTERVAL = 10; // ms
static constexpr int32_t BUFFER_HEAD_RESERVED = 14; // max : websocket header  max  len
